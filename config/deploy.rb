...
set :application, 'workout-client'
set :repo_url, 'git@github.com:xbogdan/workout-client.git'

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, '/var/www/workout-client'
...
set :linked_dirs, ['node_modules', 'bower_components'] #%w{node_modules bower_components}
